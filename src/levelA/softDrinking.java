...
public class softDrinking {
    private void solve() {
        ...
        int friends = nextInt();
        int allLiters = nextInt() * nextInt();
        int sliceOfLimes = nextInt() * nextInt();
        int salt = nextInt();
        //for toast
        int nLiters = nextInt();
        int nSalt = nextInt();

        int ans = Math.min(allLiters/nLiters, Math.min(sliceOfLimes, salt/nSalt))/friends;
